...
class TestDynamicAStarPolicy(unittest.TestCase):
    ...
    def test_dynamic_astar_avoids_other_uav(self):
    ...
    def test_dynamic_astar_preserves_connectivity(self):
    ...
    def test_dynamic_astar_blocked_set_building(self):
    ...
    def test_dynamic_astar_empty_spatial_manager(self):
