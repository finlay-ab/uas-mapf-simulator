...
\newcommand{\projectTitle}{Utilising Multi Agent Path Finding to manage Unmanned Aerial Systems in urban environments.}
\newcommand{\fullname}{Finlay Brydges}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% These have been commented out because they cannot be executed in the 
% preamble. They should remain in finalReport.tex where they are printed.
